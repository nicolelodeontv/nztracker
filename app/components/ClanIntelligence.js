...
export default function ClanIntelligence({ clan, rows, intel, events, alerts, periodHours, setPeriodHours, eventFilter, setEventFilter }) {
  ...
  const buildDiscordPost = () => {
    ...
    if (donationRows.length) {
      lines.push('', `💰 **Donations**`, '`MEMBER | GOLD | TOKEN | 1H G/T | 6H G/T | 24H G/T`');
      ...
      <div className="nz-member-table">
        ...
        <div className="nz-table-wrap nz-member-intel-wrap">
          <table className="nz-member-intel-table">
            <thead><tr><th>MEMBER</th><th>REP</th><th>GAIN</th><th>GAIN / HR</th><th>STATUS</th><th>GOLD</th><th>TOKEN</th><th>1H G/T</th><th>6H G/T</th><th>24H G/T</th></tr></thead>
            <tbody>
              ...
              )) : <tr><td colSpan="10" className="nz-empty-row">No member intelligence data available yet.</td></tr>}
            </tbody>
          </table>
        </div>
      </div>
