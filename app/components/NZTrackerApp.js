...
export default function NZTrackerApp() {
  ...
  const refreshRanking = useCallback(async () => {
    try {
      ...
      setRankingState('WAITING');
      setRankingError(error instanceof Error ? error.message : 'Ranking cache unavailable');
    }
  }, []);
