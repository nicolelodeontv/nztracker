...
export default function Home() {
  ...
  const [autoRefresh,setAutoRefresh]=useState(true),[countdown,setCountdown]=useState(10),[query,setQuery]=useState('');
